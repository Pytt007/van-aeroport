...
import { MapPin, ArrowRight, User, Phone, Calendar as LucideCalendar, Clock, Users, Star, ChevronRight, Gauge, Zap, MessageCircle, CheckCircle2, Gift } from "lucide-react";
...
const Booking = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      // @ts-ignore - RPC might not be in generated types
      const { data: isAvailable, error: checkError } = await (supabase as any).rpc('check_vehicle_availability', {
